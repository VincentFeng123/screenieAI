...
fn normalize_dom_role(item: &SafariDomElement) -> String {
    ...
    match item.role.as_str() {
        ...
        "menuitem" => return "AXMenuItem".into(),
        _ => {}
    }
